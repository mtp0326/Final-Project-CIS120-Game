 ...
 */
public abstract class GameObj extends SpecialObj {
    /*
    ...
    public boolean intersects(GameObj that) {
        return (this.px + this.width >= (that.px + 20)
                && this.py + this.height >= (that.py + 20)
                && that.px + that.width >= (this.px + 20)
                && that.py + that.height >= (this.py + 20));
    }
